<?php
/* --------------------------------------------------------------
   ShopInformationFactoryHelper.php 2019-01-15
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class ShopInformationFactoryHelper
 *
...
class ShopInformationFactory
{
    ...
    private function createShopInformationRepository()
    {
        if ($this->shopInformationRepository === null) {
            $this->shopInformationRepository = new ShopInformationRepository(
                $this->createShopDetailsRepository(),
    ...
    public function createMerchantDetailsSerializer()
    {
        if ($this->merchantDetailsSerializer === null) {
            $this->merchantDetailsSerializer = new MerchantDetailsSerializer(
                $this->createMerchantAddressDetailsSerializer()
            );
        }
    ...
    public function createShopInformationSerializer()
    {
        if ($this->shopInformationSerializer === null) {
            $this->shopInformationSerializer = new ShopInformationSerializer(
                $this->createShopDetailsSerializer(),
    ...
    public function createServerDetailsSerializer()
    {
        if ($this->serverDetailsSerializer === null) {
            $this->serverDetailsSerializer = new ServerDetailsSerializer(
                $this->createPhpServerDetailsSerializer(),
