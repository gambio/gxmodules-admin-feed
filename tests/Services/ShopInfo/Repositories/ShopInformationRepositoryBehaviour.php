<?php
/* --------------------------------------------------------------
   ShopInformationRepositoryBehaviour.inc.php 2018-08-01
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class ShopInformationRepositoryBehaviour
 */
class ShopInformationRepositoryBehaviour extends TestCase
{
	/**
	...
	public function setUp()
	{
		...
		$this->shopInformation           = ShopInformation::create($this->shopDetails, $this->serverDetails,
		                                                           ...
		                                                           $this->updatesDetails);
		$this->shopInformationRepository = ShopInformationRepository::create($this->shopRepository,
