<?php
/* --------------------------------------------------------------
   UpdatesDetailsRepositoryBehaviour.inc.php 2018-08-01
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class UpdatesDetailsRepositoryBehaviour
 */
class UpdatesDetailsRepositoryBehaviour extends TestCase
{
	/**
	...
	public function setUp()
	{
		...
		$this->repository = UpdatesDetailsRepository::create($this->mapper);
	}
