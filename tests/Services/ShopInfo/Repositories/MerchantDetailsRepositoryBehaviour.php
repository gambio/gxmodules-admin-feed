<?php
/* --------------------------------------------------------------
   MerchantDetailsRepositoryBehaviour.inc.php 2018-08-01
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class MerchantDetailsRepositoryBehaviour
 */
class MerchantDetailsRepositoryBehaviour extends TestCase
{
	/**
	...
	public function setUp()
	{
		...
		$this->repository = MerchantDetailsRepository::create($this->mapper);
	}
