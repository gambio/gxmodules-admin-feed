<?php
/* --------------------------------------------------------------
   ServerDetailsRepositoryBehaviour.inc.php 2018-08-01
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class ServerDetailsRepositoryBehaviour
 */
class ServerDetailsRepositoryBehaviour extends TestCase
{
	/**
	...
	public function setUp()
	{
		...
		$this->repository = ServerDetailsRepository::create($this->mapper);
	}
