<?php
/* --------------------------------------------------------------
   ShopDetailsRepositoryBehaviour.inc.php 2018-08-01
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class ShopDetailsRepositoryBehaviour
 */
class ShopDetailsRepositoryBehaviour extends TestCase
{
	/**
	...
	public function setUp()
	{
		...
		$this->repository = ShopDetailsRepository::create($this->mapper);
	}
