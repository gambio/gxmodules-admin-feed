<?php
/* --------------------------------------------------------------
   TemplateDetailsRepositoryBehaviour.inc.php 2018-08-01
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class TemplateDetailsRepositoryBehaviour
 */
class TemplateDetailsRepositoryBehaviour extends TestCase
{
	/**
	...
	public function setUp()
	{
		...
		$this->repository = TemplateDetailsRepository::create($this->mapper);
	}
