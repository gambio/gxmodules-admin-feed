<?php
/* --------------------------------------------------------------
   ServerDetailsMapperBehaviour.inc.php 2018-08-01
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class ServerDetailsMapperBehaviour
 */
class ServerDetailsMapperBehaviour extends TestCase
{
	/**
	 * @var string
	 */
	...
	public function setUp()
	{
		...
		$this->mapper = ServerDetailsMapper::create($this->reader);
	}
