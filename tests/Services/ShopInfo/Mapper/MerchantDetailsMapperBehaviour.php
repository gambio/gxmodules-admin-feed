<?php
/* --------------------------------------------------------------
   MerchantDetailsMapperBehaviour.inc.php 2018-08-01
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class MerchantDetailsMapperBehaviour
 */
class MerchantDetailsMapperBehaviour extends TestCase
{
	/**
	 * @var string
	 */
	...
	public function setUp()
	{
		...
		$this->mapper = MerchantDetailsMapper::create($this->reader);
	}
