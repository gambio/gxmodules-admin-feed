<?php
/* --------------------------------------------------------------
   ModulesDetailsMapperBehaviour.inc.php 2018-08-01
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class ModulesDetailsMapperBehaviour
 */
class ModulesDetailsMapperBehaviour extends TestCase
{
	/**
	...
	public function setUp()
	{
		...
		$this->mapper = ModulesDetailsMapper::create($this->reader);
	}
