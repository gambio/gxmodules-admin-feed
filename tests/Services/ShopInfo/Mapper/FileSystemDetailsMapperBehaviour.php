<?php
/* --------------------------------------------------------------
   FileSystemDetailsMapperBehaviour.inc.php 2018-08-01
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class FileSystemDetailsMapperBehaviour
 */
class FileSystemDetailsMapperBehaviour extends TestCase
{
	/**
	 * @var array
	 */
	...
	public function setUp()
	{
		...
		$this->mapper = FileSystemDetailsMapper::create($this->reader);
	}
