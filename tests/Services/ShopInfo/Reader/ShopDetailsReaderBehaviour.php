<?php
/* --------------------------------------------------------------
   ShopDetailsReaderBehaviour.inc.php 2018-08-01
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class ShopDetailsReaderBehaviour
 */
class ShopDetailsReaderBehaviour extends DbTestCase
{
	/**
	...
	public function setUp(): void
	{
		...
		$this->reader = ShopDetailsReader::create($this->settings, $this->db);
	}
