<?php
/* --------------------------------------------------------------
   ModulesDetailsReaderBehaviour.inc.php 2018-08-01
   Gambio GmbH
   http://www.gambio.de
 ...
 */
class ModulesDetailsReaderBehaviour extends DbTestCase
{
	/**
	...
	public function setUp(): void
	{
		...
		$this->reader = ModulesDetailsReader::create($this->settings, $this->db);
	}
