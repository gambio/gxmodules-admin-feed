<?php
/* --------------------------------------------------------------
   UpdatesDetailsMapperTest.inc.php 2018-08-01
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class UpdatesDetailsMapperTest
 */
class UpdatesDetailsMapperTest extends TestCase
{
	/**
	 * @var string
	 */
 ...
 public function setUp()
	{
		...
		$this->mapper = new UpdatesDetailsMapper($this->reader);
	}
